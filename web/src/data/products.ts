...
export const products: Product[] = [
  ...
  },
  {
    ...
    usage: {
      es: 'Preparar la dosis recomendada en un envase limpio. Para aplicaciones destinadas al consumo animal, consultar previamente con un técnico especializado. Comederos: 2–3 L de activado por mochila de 20 L. Bebederos: 10 ml de activado para 1000 L de agua. Instalaciones: 5 L del activado por mochila de 20 L.',
      en: 'Prepare the recommended dose in a clean container. For animal-consumption applications, consult a specialized technician first. Feeders: 2–3 L of activated product per 20 L tank. Drinkers: 10 ml of activated product per 1000 L of water. Facilities: 5 L of activated product per 20 L tank.',
    },
